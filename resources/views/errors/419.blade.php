            ...
            <div class="col-lg-7 mx-auto text-white">
              <div class="row align-items-center d-flex flex-row">
                ...
                <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4" style="color:#000000">
                  <h2>SORRY!</h2>
                  <h3 class="font-weight-light">We have waited for you soo long.</h3>
                </div>
              </div>
              <div class="row mt-5">
                <div class="col-12 text-center mt-xl-2">
                  <a class="font-weight-medium btn btn-outline-primary" style="color:#000000" href="{{url('')}}">Click to continue</a>
                </div>
              </div>
              <div class="row mt-5">
